---
title: "2022-01-14_table-and-spatial-joins"
...
bus_passups_with_metadata <- left_join(bus_passups_fall_2021, all_trips_fall_2021,
  ...
  left_join(___, by = _("_____", "______"))
```
...
clean_planner_assignments <- planner_assignments %>% 
  ...
  mutate(route_number = as.numeric(route_number)) #as a precaution, I am going to drop duplicate rows
