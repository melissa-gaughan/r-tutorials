...
nov_sat_passups <- block_group_passups %>% 
  filter(CAL_MONTH_IN_YEAR_NUM == 11 & SCHED_DAY_TYPE_CODED_NUM== 1)

nov_wkd_passups <- block_group_passups %>% 
  filter(CAL_MONTH_IN_YEAR_NUM == 11 & SCHED_DAY_TYPE_CODED_NUM== 0)
nov_sun_passups <- block_group_passups %>% 
  filter(CAL_MONTH_IN_YEAR_NUM == 11 & SCHED_DAY_TYPE_CODED_NUM== 2)
```
