...
```{r}
activity_url <- "https://github.com/melissa-gaughan/r-tutorials/blob/main/2021-12-3_dplyr_tutorial/data/trip_detail_Fall_2021.zip"

vroom(temp)
ile = read.table(unzip("https://github.com/melissa-gaughan/r-tutorials/blob/main/2021-12-3_dplyr_tutorial/data/trip_detail_Fall_2021.zip"), sep = ",", header = TRUE)
temp <- tempfile()
download.file(activity_url, temp)
unzip(temp, "trip_detail_Fall_2021.csv", exdir ="C:/Users/mgaughan/Documents/metro-r-tutorials/data" )
# note that here I modified your original read.table() which did not work
mydata <- read.csv("trip_detail_Fall_2021.csv")
unlink(temp)
```

```{r}
setwd(dir = "C:/Users/mgaughan/Documents/")
